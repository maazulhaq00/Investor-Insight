...
<html lang="en">
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-3 col-lg-3 col-xl-2">
                        <div class="info_item">
                            ...
                            <h5>Free Call:</h5>
                            <h6 class="active">+00 123 456 789</h6>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-xl-2">
                        <div class="info_item">
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-2 noPaddingRight">
                        <div class="info_item">
                            <i class="bx bxs-map"></i>
                            <h5>Visit Us:</h5>
                            <h6>7 King Street, London</h6>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-3">
                        <div class="logo_01">
                            <a href="index.html">
                                <img src="images/Investor_insight.png" alt="investor_insight"/>
                            </a>
                        </div>
                    </div>
                        ...
                        <nav class="menu_1">
                            ...
                            <ul>
                                <li class="current-menu-item menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="index.html">Mulitpage 01</a></li>
                                        <li><a href="index2.html">Multipage 02</a></li>
                                        <li><a href="index3.html">Multipage 03</a></li>
                                        <li><a href="index4.html">Onepage Version</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="meet_our_advisor.html">Meet Our Advisor</a></li>
                                        <li><a href="award_and_recognition.html">Award & Recognition</a></li>
                                        <li><a href="pricing_table.html">Pricing Table</a></li>
                                        <li><a href="help_and_faqs.html">Help & FAQs</a></li>
                                        <li class="menu-item-has-children">
                                ...
                                <li class="menu-item-has-children">
                                    <a href="#">Case</a>
                                    <ul class="sub-menu">
                                        <li><a href="case_studies.html">Case Studies One</a></li>
                                        <li><a href="case_studies2.html">Case Studies Two</a></li>
                                        <li><a href="single_case_studies.html">Single Case Study</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-children">
                                    <a href="#">Service</a>
                                    <ul class="sub-menu">
                                        <li><a href="our_services.html">Our Services One</a></li>
                                        <li><a href="our_services2.html">Our Services Two</a></li>
                                        <li><a href="our_services3.html">Our Services Three</a></li>
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="single_blog_post.html">Blog Single Post</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-children">
                                    <a href="#">Shop</a>
                                    <ul class="sub-menu">
                                        <li><a href="shop_product.html">Shop Products</a></li>
                                        <li><a href="shop_product_left_sidebar.html">Products Left Bar</a></li>
                                        <li><a href="shop_product_right_sidebar.html">Products Right Bar</a></li>
                                        <li><a href="single_shop_product.html">Single Product</a></li>
                                    </ul>
                                </li>
                            ...
                            <div class="access_btns">
                                ...
                                <div class="cart_btn">
                                    <a href="#"><i class="bx bx-shopping-bag"></i><span>3</span></a>
                                    <div class="mini_cart">
                                        <div class="mc_item">
                                            <img src="images/cart/1.jpg" alt=""/>
                                            <h4><a href="#">The Wisdom of Finance</a></h4>
                                        ...
                                        <div class="mc_item">
                                            ...
                                            <h4><a href="#">Wealth Hacking Secrets</a></h4>
                                            <div class="product_price clearfix">
                                        ...
                                        <div class="mc_item">
                                            ...
                                            <h4><a href="#">Health Care Finance</a></h4>
                                            <div class="product_price clearfix">
                                        ...
                                        <div class="total_price">Subtotal: <span class="price"><span><span>$</span>112.00</span></span></div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pb_content text-center">
                            <h2>About Us</h2>
                            <p><a href="index.html">Home</a><b>-</b><span>About Us</span></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single_skill" data-parcent="99">
                            <h4>Investment Management</h4>
                            <div class="ss_parent"><div class="ss_child"></div><span>99%</span></div>
                        </div>
                        <div class="single_skill" data-parcent="85">
                            <h4>Deposit Compare</h4>
                            <div class="ss_parent"><div class="ss_child"></div><span>85%</span></div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="single_skill" data-parcent="90">
                            <h4>Loan Management</h4>
                            <div class="ss_parent"><div class="ss_child"></div><span>90%</span></div>
                        </div>
                        <div class="single_skill" data-parcent="70">
                            <h4>Mutual Funding</h4>
                            <div class="ss_parent"><div class="ss_child"></div><span>70%</span></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Team Section Start -->
        <section class="team_section gray_bg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h5 class="sub_title">Our Team</h5>
                        <h2 class="sec_title">Meet Our Advisor</h2>
                    </div>
                </div>
                <div class="row">
        ...
        <section class="fun_fact_section_2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h5 class="sub_title lights">Some Facts</h5>
                        <h2 class="sec_title lights">Our Company In Numbers</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="fact_01 text-center">
                            <h2 class="counters" data-count="1245">1245</h2>
                            <h5>Coffee Cups</h5>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="fact_01 text-center">
                            <h2 class="counters" data-count="6524">6524</h2>
                            <h5>Satisfied Clients</h5>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="fact_01 text-center">
                            <h2 class="counters" data-count="8248">8248</h2>
                            <h5>Finished Projects</h5>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="fact_01 text-center">
                            <h2 class="counters" data-count="9731">9731</h2>
                            <h5>Worked Hours</h5>
                        </div>
                    </div>
                </div>
        ...
        <section class="testimonial_section white_bg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h5 class="sub_title">Testimonials</h5>
                        <h2 class="sec_title">What Clients Say About Us</h2>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 noPaddingRight">
                        <div class="cta_images tw-stretch-element-inside-column">
                            <img src="images/home_02/2.jpg" alt=""/>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="cta_content">
                            <h5 class="sub_title no_bars">Call Us Now</h5>
                            <h2 class="sec_title lights">Investment Can Be Provided Through Different Sources</h2>
                            <div class="dvd_bar"></div>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore 
                                magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. 
                            </p>
                            <h2 class="free_calls"><i class="bx bx-support"></i>Free Call: <span>+00 123 456 789</span></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 text-right">
                        <a href="request_a_quote" class="fnc_btn wh"><span>Request a Quote<i class="bx bx-right-arrow-alt"></i></span></a>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-md-6 col-lg-3 col-xl-4">
                        <div class="widget">
                            <div class="about_widget">
                                ...
                                <p>
                                    It deals with the questions of how an individual, 
                                    company or government acquires the money needed called capital in the 
                    ...
                    <div class="col-md-6 col-lg-3 col-xl-2">
                        <div class="widget">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Investment in Bonds</a></li>
                                <li><a href="#">Invest Management</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="copies">
                            2020 © <a href="#">Investor Insight</a>. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
